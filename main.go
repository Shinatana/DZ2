...
// Общие константы для вычислений. Для меня "звездочка"
const (
...
func (t Training) meanSpeed() float64 {
	// вставьте ваш код ниже преодолённая_дистанция_за_тренировку_в_км / время_тренировки_в_часах
	distance := t.distance()
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	return (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Training.Weight * float64(s.Training.Duration)
}
